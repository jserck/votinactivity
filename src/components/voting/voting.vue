                ...
                <section class="g-vote-list">
                    <ul>
                        ...
                        >
                            ...
                            <span v-else class="g-btn" style="background:#C85657;color:#fff">已关注</span>
                            <!-- </span> -->
                        </li>
                        <li class="displayFlex flexJustifybetween flexAlignItemsCenter">
                            ...
                            <span v-else class="g-btn" style="background:#C85657;color:#fff">已签到</span>
                            <!-- </span> -->
                        </li>
                        <li class="displayFlex flexJustifybetween flexAlignItemsCenter">
                            <span class="displayFlex flexJustifybetween flexAlignItemsCenter">
            ...
            ul {
                ...
                li {
                    .g-vote-li {
                        ...
                        height: 2.58rem;
                        // background:#FFE5D4;
                        @include background("/static/images/starvote@2x.png");
                    }
                    span {
                        display: block;
                    }
                ...
                ul {
                    li {
                        ...
                        .u-icon1 {
                            ...
                            width: 0.38rem;
                            height: 0.39rem;
                            @include background("/static/images/people@2x.png");
                        }
                        .u-icon2 {
                            margin-right: 0.12rem;
                            display: inline-block;
                            width: 0.38rem;
                            height: 0.39rem;
                            @include background("/static/images/duigou@2x.png");
                        }
                        .u-icon3 {
                            margin-right: 0.12rem;
                            display: inline-block;
                            width: 0.38rem;
                            height: 0.39rem;
                            @include background("/static/images/book@2x.png");
                        }
                        .u-icon4 {
                            margin-right: 0.12rem;
                            display: inline-block;
                            width: 0.38rem;
                            height: 0.39rem;
                            @include background("/static/images/fanhui@2x.png");
                        }
                        .g-btn {
                            margin-left: 0.36rem;
                            display: inline-block;
