...
function isDateBetween(newDa, startDateString, endDateString) {
    var flag = false;
    var startFlag = (dateCompare(newDa, startDateString) < 1);
    var endFlag = (dateCompare(newDa, endDateString) > -1);
